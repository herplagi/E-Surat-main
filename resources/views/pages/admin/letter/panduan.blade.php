    ...
    <main>
        ...
        <div class="container-xl px-4 mt-n15">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="card mb-4">
                        <div class="card-header">KORIN</div>
                        <div class="card-body">
                            <iframe src="{{ url('admin/assets/pdf/Instruksi.pdf') }}" frameborder="0">
                            </iframe>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card mb-4">
                        <div class="card-header">KRE</div>
                        <div class="card-body">
                            <iframe src="{{ url('admin/assets/pdf/KRE.pdf') }}" frameborder="0">
                            </iframe>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <iframe src="{{ url('admin/assets/pdf/Pengumuman.pdf') }}" frameborder="0">
                            </iframe>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <iframe src="{{ url('admin/assets/pdf/Keterangan.pdf') }}" frameborder="0">
                            </iframe>
                        </div>
                    </div>
                </div>
                <div class="col-6">
                    <div class="card mb-4">
                        <div class="card-header">Undangan Rapat</div>
                        <div class="card-body">
                            <iframe src="{{ url('admin/assets/pdf/Undangan.pdf') }}" frameborder="0">
                            </iframe>
                        </div>
                    </div>
                </div>
                @foreach ($item as $items)
                    <div class="col-6">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <iframe src="{{ asset('storage/public/letter-panduan/' . $items->file) }}" frameborder="0"
                                    class="mt-4 mb-4">
                                </iframe>
                            </div>
                        </div>
