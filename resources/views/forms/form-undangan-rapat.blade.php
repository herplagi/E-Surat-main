<div class="container">
    <form method="post" action="{{ route('undangan-rapat.store') }}" target="_blank">
        @csrf
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="date"
                    ...
                    value="{{ old('letter_date') }}" name="tanggal_surat" required>
            </div>
            @error('tanggal_surat')
                <div class="invalid-feedback">
                    {{ $message }}
        ...
        <div class="mb-3 row ">
            <label for="jabatan_pengirim" class="col-sm-3 col-form-label">Jabatan Pengirim</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="jabatan_pengirim" placeholder="Jabatan Pengirim.." required>
            </div>
