<div class="container">
    <form method="post" action="{{ route('pengumuman.store') }}" target="_blank">
        @csrf
        ...
        <div class="mb-3 row ">
            <label for="isi_pengumuman" class="col-sm-3 col-form-label">Isi Pengumuman</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="isi_pengumuman" placeholder="Isi Pengumuman..." required>
            </div>
        ...
        <div class="mb-3 row ">
            <label for="nama_terang" class="col-sm-3 col-form-label">Nama Terang</label>
            <div class="col-sm-9">
                <input type="text" class="form-control" name="nama_terang" placeholder="Nama Terang..." required>
            </div>
            @error('nama_terang')
                <div class="invalid-feedback">
                    {{ $message }}
